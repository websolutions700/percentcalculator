window.onload = ()=> {
	...
	document.querySelector('nav i.fa').onclick = ()=> {
				document.querySelector('.mobile-navbar').classList.toggle('active');
				if (document.querySelector('.mobile-navbar').classList.contains('active')) {
					document.querySelector('nav i.fa').classList.replace('fa-bars', 'fa-times');
				} else {
					document.querySelector('nav i.fa').classList.replace('fa-times', 'fa-bars');
				}
			}
